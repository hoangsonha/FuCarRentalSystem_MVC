...
<title>Admin CarRent Page</title>
<link
...
<body>
	...
	<div class="pagetitle">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">CarRental</li>
		</ol>
		</nav>
	</div>
	<!-- End Page Title -->
		...
		<div class="col-md-12">
			<div>
				...
				<div class="collapsible-content">
					...
					<form action="/adminManagerCarRental" id="Oamuser_Form_1"
						method="post">
							...
							<div class="col-md-12">
											...
											<tbody>
												...
												<tr style="background-color: #ffffff">
													...
													<td align="center"><input style="width: 100%"
														type="text" id="input1" name="carRentalID" value=""
														readonly="readonly"></td>
													<td>CustomerID</td>
													<td align="center"><input style="width: 100%"
														type="text" id="input2" name="customer" value=""></td>
												</tr>
												<tr style="background-color: #ffffff">
													<td>CarID</td>
													<td align="center"><input style="width: 100%"
														type="text" id="input3" name="car" value=""></td>
													<td>Pickup Date</td>
													<td align="center"><input style="width: 100%"
														type="text" id="input4" name="pickupDate" value=""></td>
												</tr>

												<tr style="background-color: #ffffff">
													<td>Return Date</td>
													<td align="center"><input style="width: 100%"
														type="text" id="input5" name="returnDate" value=""></td>
													<td>Rent Price</td>
													<td align="center"><input style="width: 100%"
														type="text" id="input6" name="rentPrice" value="" min="1"></td>
												</tr>

												<tr style="background-color: #ffffff">
													<td>Status</td>
													<td align="center"><input style="width: 100%"
														type="text" id="input7" name="status" value=""></td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div align="left">
									<div class="clearfix">
										...
										<button type="submit" id="Oamuser_Button_2" name="btnManager"
										...
										<button type="submit" id="Oamuser_Button_1" name="btnManager"
											value="update" class="btn btn-warning"
											style="margin-right: 10px;">
											<i class="fa fa-edit"></i> Update
										</button>

										<button type="submit" id="Oamuser_Button_3" name="btnManager"
											value="delete" id="delete" data-placement="left"
											data-btn-cancel-label="Cancel" data-btn-ok-label="Agree"
